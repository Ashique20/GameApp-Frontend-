...
const Chat =()=>{
  ...
  useEffect(()=>{
    ...
    return(
    //     
    <div  className="card lg:card-side bg-base-100 shadow-xl" style={{ backgroundImage: `url("https://images.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltbded518020183769/5eb26f5389bac8148a8006cc/agent-background-generic.JPG ") ` }} >
