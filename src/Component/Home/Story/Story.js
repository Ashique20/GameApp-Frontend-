...
const Story=()=>{
  ...
  useEffect(()=>{
    ...
    return(
            ...
            <div className=" min-h-screen  base-200 " style={{ backgroundImage: `url("https://images.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltbded518020183769/5eb26f5389bac8148a8006cc/agent-background-generic.JPG ") ` }} >
